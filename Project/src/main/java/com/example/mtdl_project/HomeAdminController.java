...
public class HomeAdminController implements Initializable {
    ...
    public void seeAllAccounts(ActionEvent event) throws IOException {
        Scene allAccounts =new Scene(FXMLLoader.load(MTDL_Project.class.getResource("AllUsersAdmin.fxml")));
        Stage stage=(Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(allAccounts);
